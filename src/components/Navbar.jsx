...
return (
    ...
    <div className="flex justify-between items-center px-10 py-4 text-white bg-black pr-25">
      ...
      <div className="text-2xl space-x-13 pt-10 ">
        <a className="inline-block hover:scale-110 hover:text-[#76B5CB] hover:underline transition-transform duration-300 ease-in-out" href="#Home">Home</a>
        <a className="inline-block hover:scale-110 hover:text-[#76B5CB] hover:underline transition-transform duration-300 ease-in-out" href="#Skill">Skills</a>
        <a className="inline-block hover:scale-110 hover:text-[#76B5CB] hover:underline transition-transform duration-300 ease-in-out" href="#Education">Education</a>
        <a className="inline-block hover:scale-110 hover:text-[#76B5CB] hover:underline transition-transform duration-300 ease-in-out" href="#Experience">Experience</a>
        <a className="inline-block hover:scale-110 hover:text-[#76B5CB] hover:underline transition-transform duration-300 ease-in-out" href="#Contact">Contact</a>
      </div>
      </div>
